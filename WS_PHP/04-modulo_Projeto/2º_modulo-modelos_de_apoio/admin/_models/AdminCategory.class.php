...
class AdminCategory {
    ...
    /**
     * <b>Cadastrar Categoria:</b> Envelope titulo, descrição, data e sessão em um array atribuitivo e execução
     * para cadastrar a categoria. Caso seja uma sessão, envie o category_parent como STRING null. 
    ...
    /**
     * <b>Atualizar Categoria:</b> Envelope os dados em uma array atribuitivo em informe o id de uma
    ...
    /**
     * <b>Deleta categoria:</b> Informe o ID de uma categoria para remove-lá do sistema. Esse método verifica
    ...
    public function ExeDelete($CategoryId) {
        ...
        if (!$read->getResult()):
            ...
            elseif($category_parent && !$this->checkPosts()):
                $this->Result = false;
                $this->Error = ["A <b>categoria {$category_title}</b> possui artigos cadastradas. Para deletar, antes altere ou remova todos os posts desta categoria!", WS_ALERT];
            else:
                $delete = new Delete;
    ...
    /**
     * <b>Obter Erro:</b> Retorna um array associativo com a mensagem e o tipo erro!
    ...
    //Verificar o NAME da categoria. Se existir adiciona um pós-fix +1

    ...
    <article>
        ...
        <form name="PostForm" action="" method="post" enctype="multipart/form-data">
            ...
            <label class="label">
                ...
                <input type="text" name="category_title" value="<?php if (isset($data)): echo $data['category_title']; endif;?>" />
            </label>

            <label class="label">
                <span class="field">Conteúdo:</span>
                <textarea name="category_content" rows="5"><?php if (isset($data)): echo $data['category_content']; endif; ?></textarea>
            </label>
                ...
                <label class="label_small left">
                    ...
                    <select name="category_parent">
                        ...
                        if (!$readSes->getResult()):
                            echo '<option disabled="disabled" value="null"> Cadastre antes uma sessão! </option>';
                        else:

<!DOCTYPE html>
<?php
define('BASE', 'http://localhost/exercicio_upinside_treinamentos/html5_do_jeito_certo/7%C2%BA_modulo-estilo_interativo_com_id/04_servindo_dobra_de_caracteristica/');
?>
<html lang="pt-br">
    <head>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <article class="container">
            <div class="content">
                ...
                <video class="video video-large main_video" src="midia/video.mp4" controls width="400"></video>
                
                <aside class="al-center">
                    <h1>Pronto para <a class="btn btn-yelow radius" title="Comprar Curso WS HTML5 Agora!" target="_blank" href="https://www.upinside.com.br/cursos/html5-do-jeito-certo">Comprar o WS HTML5</a> e Aprender de Verdade?</h1>
                </aside>                
                <div class="clear"></div>
            </div>

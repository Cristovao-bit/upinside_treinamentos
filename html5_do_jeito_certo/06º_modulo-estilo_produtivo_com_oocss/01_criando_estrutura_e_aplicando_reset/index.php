<!DOCTYPE html>
<?php
define('BASE', 'http://localhost/exercicio_upinside_treinamentos/html5_do_jeito_certo/6%C2%BA_estilo_produtivo_com_oocss/01_criando_estrutura_e_aplicando_reset/');
?>
<html lang="pt-br">
    <head>
        <meta charset="UTF-8">

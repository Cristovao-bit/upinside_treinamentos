...
define('HOME' , 'http://localhost/exercicio_upinside_treinamentos/html5_do_jeito_certo/09%C2%BA_modulo-extensibilidade_com_microformatos/01_preparando_ambiente_de_marcacao');
define('THEME' , 'wshtml');

...
define('HOME' , 'http://localhost/exercicio_upinside_treinamentos/html5_do_jeito_certo/08%C2%BA_modulo-distribuicao_otimizada_com_seo_e_smo/08_convertendo_ativamente_e_finalizando');
define('THEME' , 'wshtml');

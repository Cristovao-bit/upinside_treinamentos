<!DOCTYPE html>
<?php
define('BASE', 'http://localhost/exercicio_upinside_treinamentos/html5_do_jeito_certo/8%C2%BA_modulo-distribuicao_otimizada_com_seo_e_smo/01_atualizando_conceito_hgroup/');
?>
<html lang="pt-br">
    <head>
        <meta charset="UTF-8">
